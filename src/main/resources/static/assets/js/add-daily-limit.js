$(function () {
    ...
    $(document).on("click", "#submitBtn", function () {
        if ($("#add-daily-limit-form").valid()) {
            ...
            const URL =
                ...
                "/" +
                $("#partnerId").val() +
                "/limits/daily-limits/transfer-acceptor-limits";
            ...
            $.ajax({
                ...
                success: function (response, _statusCode, _xhr) {
                    ...
                    $("#submitBtn").attr(
                        "data-add-daily-limit-request",
                        JSON.stringify(
                            $("#add-daily-limit-form").serializeArray()
                        )
                    );
                    $("#submitBtn").attr(
                        "data-add-daily-limit-response",
    ...
    function createRequestObject() {
        ...
        let serialized = $("#add-daily-limit-form").serializeArray();
        let data = {};
