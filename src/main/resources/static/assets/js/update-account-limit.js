$(function () {
    ...
    $("#update-account-limit-form").validate({
        ignore: [],
    ...
    $(document).on("click", "#submitBtn", function () {
        if ($("#update-account-limit-form").valid()) {
            ...
            $.ajax({
                ...
                success: function (response, _statusCode, _xhr) {
                    ...
                    $("#submitBtn").attr(
                        "data-update-account-limit-request",
                        JSON.stringify(
                            $("#update-account-limit-form").serializeArray()
                        )
                    );
                    $("#submitBtn").attr(
                        "data-update-account-limit-response",
    ...
    function createRequestObject() {
        ...
        let serialized = $("#update-account-limit-form").serializeArray();
        let data = {};
        ...
        if (data.accountLimitReference) {
            delete data.accountLimitReference;
        }
