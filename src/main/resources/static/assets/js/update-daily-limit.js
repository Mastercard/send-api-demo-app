$(function () {
    ...
    $("#update-daily-limit-form").validate({
        ignore: [],
        ...
        rules: {
            ...
            transferAcceptorLimitReference: {
                required: true,
            },
            accept: {},
            contentType: {},
    ...
    $(document).on("click", "#submitBtn", function () {
        if ($("#update-daily-limit-form").valid()) {
            ...
            $.ajax({
                ...
                success: function (response, _statusCode, _xhr) {
                    ...
                    $("#submitBtn").attr(
                        "data-update-daily-limit-request",
                        JSON.stringify(
                            $("#update-daily-limit-form").serializeArray()
                        )
                    );
                    $("#submitBtn").attr(
                        "data-update-daily-limit-response",
    ...
    function createRequestObject() {
        ...
        let serialized = $("#update-daily-limit-form").serializeArray();
        let data = {};
        ...
        if (data.transferAcceptorLimitReference) {
            delete data.transferAcceptorLimitReference;
        }
